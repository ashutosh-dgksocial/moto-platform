...
const AppHeader = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: any) => {
      // console.log("Clicked target:", event.target); // Logs the clicked element
        ...
        <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 py-4 md:px-8">
          ...
          <div className="mr-1 flex items-center space-x-2 md:mr-6">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl font-bold leading-9 md:text-4xl">
                Drivco
              </h1>
          ...
          <div className="ml-4 flex items-center space-x-5">
            ...
            >
              ...
              <div className="ml-2 block md:hidden">
                <Hamburger isOpen={isOpen} onClick={toggleSidebar} />
              </div>
            </a>
          </div>
        </div>
      </header>
      {/* Background overlay with blur effect when sidebar is open */}
      {isOpen && (
        <div
